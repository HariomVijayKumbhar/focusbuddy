...
export function FocusTimer({ onSessionStart, onSessionComplete, onSessionCancel, distractingApps = [] }: FocusTimerProps) {
  ...
  }, [isRunning, timeRemaining, sessionType, totalDuration, onSessionComplete]);
  ...
  const handleStart = useCallback(() => {
    ...
    setIsRunning(true);
    setIsComplete(false);
  }, [isRunning, timeRemaining, totalDuration, onSessionStart]);
